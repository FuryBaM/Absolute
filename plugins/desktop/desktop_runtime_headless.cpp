...
extern "C" void* absolute_desktop_native_display(int64_t) { return nullptr; }
...
// Soft sprites live in desktop_soft_sprites.cpp (shared with Win32/X11).

extern "C" int32_t absolute_desktop_text_count(int64_t) { return 0; }
extern "C" int32_t absolute_desktop_text_pop(int64_t) { return -1; }
extern "C" void absolute_desktop_text_clear(int64_t) {}
