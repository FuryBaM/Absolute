...
@print.format.31 = private unnamed_addr constant [22 x i8] c"Assertion failed: %s\0A\00", align 1
@string.literal.32 = private unnamed_addr constant [20 x i8] c"Index out of bounds\00", align 1
@null.text.33 = private unnamed_addr constant [7 x i8] c"<null>\00", align 1
@print.format.34 = private unnamed_addr constant [22 x i8] c"Assertion failed: %s\0A\00", align 1
@array.bounds.message.35 = private unnamed_addr constant [26 x i8] c"Array index out of bounds\00", align 1
@array.bounds.message.36 = private unnamed_addr constant [26 x i8] c"Array index out of bounds\00", align 1
...
if.body:                                          ; preds = %entry
  ...
  %vtable.address = getelementptr inbounds %absolute.class.Error, ptr %managed.pointee, i32 0, i32 0
  store ptr @Error.__vtable, ptr %vtable.address, align 8
  call void @"Error.__ctor$string"(ptr %managed.pointee, ptr @string.literal.27)
  %error.pending = call i1 @absolute_error_pending()
  br i1 %error.pending, label %error.propagate, label %error.continue
...
array.bounds.failure27:                           ; preds = %array.bounds.success
  %2 = call i32 @puts(ptr @array.bounds.message.29)
  call void @exit(i32 1)
  unreachable
}
...
assert.failure:                                   ; preds = %entry
  %print.result = call i32 (ptr, ...) @printf(ptr @print.format.31, ptr @string.literal.30)
  call void @abort()
  unreachable
}
...
assert.failure:                                   ; preds = %entry
  %print.result = call i32 (ptr, ...) @printf(ptr @print.format.34, ptr @string.literal.32)
  call void @abort()
  unreachable
}
...
array.bounds.failure:                             ; preds = %while.body
  %0 = call i32 @puts(ptr @array.bounds.message.35)
  call void @exit(i32 1)
  unreachable
...
array.bounds.failure22:                           ; preds = %array.bounds.success
  %1 = call i32 @puts(ptr @array.bounds.message.36)
  call void @exit(i32 1)
  unreachable
}
...
while.body:                                       ; preds = %while.condition
  ...
  %values.cached.pointee2 = load ptr, ptr %values.cached.pointee, align 8
  %state.value3 = load i32, ptr %state, align 4
  call void @"std.collections.Vector<int32>.push$int32"(ptr %values.cached.pointee2, i32 %state.value3)
...
while.condition5:                                 ; preds = %while.end16, %while.end
  %outer.value = load i32, ptr %outer, align 4
  %SIZE.value8 = load i32, ptr %SIZE, align 4
  %less9 = icmp slt i32 %outer.value, %SIZE.value8
  br i1 %less9, label %while.body6, label %while.end7

while.body6:                                      ; preds = %while.condition5
  %outer.value10 = load i32, ptr %outer, align 4
  %values.value11 = load i64, ptr %values, align 4
  %values.cached.pointee12 = load ptr, ptr %values.cached.pointee, align 8
  %property.result = call i32 @"std.collections.Vector<int32>.__absolute_indexer_get$int32"(ptr %values.cached.pointee12, i32 %outer.value10)
  store i32 %property.result, ptr %key, align 4
  %outer.value13 = load i32, ptr %outer, align 4
  %sub = sub i32 %outer.value13, 1
  store i32 %sub, ptr %j, align 4
  br label %while.condition14

while.end7:                                       ; preds = %while.condition5
  store i64 0, ptr %checksum, align 4
  store i32 0, ptr %i, align 4
  br label %while.condition35

while.condition14:                                ; preds = %if.end, %while.body6
  %j.value = load i32, ptr %j, align 4
  %greater.equal = icmp sge i32 %j.value, 0
  br i1 %greater.equal, label %while.body15, label %while.end16

while.body15:                                     ; preds = %while.condition14
  %j.value17 = load i32, ptr %j, align 4
  %values.value18 = load i64, ptr %values, align 4
  %values.cached.pointee19 = load ptr, ptr %values.cached.pointee, align 8
  %property.result20 = call i32 @"std.collections.Vector<int32>.__absolute_indexer_get$int32"(ptr %values.cached.pointee19, i32 %j.value17)
  store i32 %property.result20, ptr %cur, align 4
...
while.end16:                                      ; preds = %if.body, %while.condition14
  %j.value28 = load i32, ptr %j, align 4
  %add29 = add i32 %j.value28, 1
  %key.value30 = load i32, ptr %key, align 4
  %values.value31 = load i64, ptr %values, align 4
  %values.cached.pointee32 = load ptr, ptr %values.cached.pointee, align 8
  call void @"std.collections.Vector<int32>.__absolute_indexer_set$int32$int32"(ptr %values.cached.pointee32, i32 %add29, i32 %key.value30)
  %assignment.current33 = load i32, ptr %outer, align 4
  %add34 = add i32 %assignment.current33, 1
  store i32 %add34, ptr %outer, align 4
  br label %while.condition5, !llvm.loop !1

if.end:                                           ; preds = %while.body15
  %j.value21 = load i32, ptr %j, align 4
  %add22 = add i32 %j.value21, 1
  %cur.value23 = load i32, ptr %cur, align 4
  %values.value24 = load i64, ptr %values, align 4
  %values.cached.pointee25 = load ptr, ptr %values.cached.pointee, align 8
  call void @"std.collections.Vector<int32>.__absolute_indexer_set$int32$int32"(ptr %values.cached.pointee25, i32 %add22, i32 %cur.value23)
  %assignment.current26 = load i32, ptr %j, align 4
  %sub27 = sub i32 %assignment.current26, 1
  store i32 %sub27, ptr %j, align 4
  br label %while.condition14

if.body:                                          ; preds = %while.body15
  br label %while.end16

while.condition35:                                ; preds = %while.body36, %while.end7
  %i.value38 = load i32, ptr %i, align 4
  %SIZE.value39 = load i32, ptr %SIZE, align 4
  %less40 = icmp slt i32 %i.value38, %SIZE.value39
  br i1 %less40, label %while.body36, label %while.end37

while.body36:                                     ; preds = %while.condition35
  %i.value41 = load i32, ptr %i, align 4
  %values.value42 = load i64, ptr %values, align 4
  %values.cached.pointee43 = load ptr, ptr %values.cached.pointee, align 8
  %property.result44 = call i32 @"std.collections.Vector<int32>.__absolute_indexer_get$int32"(ptr %values.cached.pointee43, i32 %i.value41)
  %assignment.current45 = load i64, ptr %checksum, align 4
  %int.cast = sext i32 %property.result44 to i64
  %add46 = add i64 %assignment.current45, %int.cast
  store i64 %add46, ptr %checksum, align 4
  %assignment.current47 = load i32, ptr %i, align 4
  %add48 = add i32 %assignment.current47, 1
  store i32 %add48, ptr %i, align 4
  br label %while.condition35

while.end37:                                      ; preds = %while.condition35
  %values.value49 = load i64, ptr %values, align 4
  %values.cached.pointee50 = load ptr, ptr %values.cached.pointee, align 8
  %property.result51 = call i32 @"std.collections.Vector<int32>.__absolute_indexer_get$int32"(ptr %values.cached.pointee50, i32 0)
  store i32 %property.result51, ptr %first, align 4
  %SIZE.value52 = load i32, ptr %SIZE, align 4
  %sub53 = sub i32 %SIZE.value52, 1
  %values.value54 = load i64, ptr %values, align 4
  %values.cached.pointee55 = load ptr, ptr %values.cached.pointee, align 8
  %property.result56 = call i32 @"std.collections.Vector<int32>.__absolute_indexer_get$int32"(ptr %values.cached.pointee55, i32 %sub53)
  store i32 %property.result56, ptr %last, align 4
  %first.value = load i32, ptr %first, align 4
  %int.cast57 = sext i32 %first.value to i64
  %mul58 = mul i64 %int.cast57, 31
  %assignment.current59 = load i64, ptr %checksum, align 4
  %add60 = add i64 %assignment.current59, %mul58
  store i64 %add60, ptr %checksum, align 4
  %last.value = load i32, ptr %last, align 4
  %int.cast61 = sext i32 %last.value to i64
  %mul62 = mul i64 %int.cast61, 17
  %assignment.current63 = load i64, ptr %checksum, align 4
  %add64 = add i64 %assignment.current63, %mul62
  store i64 %add64, ptr %checksum, align 4
  %checksum.value = load i64, ptr %checksum, align 4
  %print.result = call i32 (ptr, ...) @printf(ptr @print.format, i64 %checksum.value)
  %cleanup.handle65 = load i64, ptr %values, align 4
  %managed.pointee66 = call ptr @absolute_managed_get(i64 %cleanup.handle65)
  %aggregate.present69 = icmp ne ptr %managed.pointee66, null
  br i1 %aggregate.present69, label %aggregate.cleanup67, label %aggregate.cleanup.end68

aggregate.cleanup67:                              ; preds = %while.end37
  %aggregate.vtable70 = load ptr, ptr %managed.pointee66, align 8
  %aggregate.destroy.slot71 = getelementptr ptr, ptr %aggregate.vtable70, i64 0
  %aggregate.destroy72 = load ptr, ptr %aggregate.destroy.slot71, align 8
  call void %aggregate.destroy72(ptr %managed.pointee66)
  br label %aggregate.cleanup.end68

aggregate.cleanup.end68:                          ; preds = %aggregate.cleanup67, %while.end37
  call void @absolute_managed_destroy(i64 %cleanup.handle65)
  store i64 0, ptr %values, align 4
