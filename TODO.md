...
- [x] Поддержать переменные уровня модуля в кодогенерации. Хранилище на уровне
  ...
  Осталось два не-дефекта: сообщение «Top-level executable statements cannot be
  combined with an explicit main function» описывает разбор, а не суть
  ограничения, и само ограничение «на уровне модуля только примитивы» нигде не
  задокументировано.
