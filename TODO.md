...
- [ ] Не поддержаны составные присваивания сдвига `>>=` и `<<=`: в парсере их
  нет, программа не компилируется. Отсутствующая возможность, не тихий дефект.
...
- [ ] Не поддержаны формы записи чисел: шестнадцатеричная `0xFF`, двоичная
  `0b1010`, восьмеричная `0o17`, разделители `1_000_000`, экспонента `1e3`.
  Все дают честную синтаксическую ошибку, то есть это отсутствующие
  возможности, а не молчаливые дефекты, но экспонента для double —
  общепринятая запись.
