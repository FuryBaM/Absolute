...
if(NOT IR MATCHES "define i64 @inspect\\(ptr nocapture nonnull readonly %value\\)")
    message(FATAL_ERROR "const T& parameter is missing nonnull/nocapture/readonly attributes")
endif()
if(NOT IR MATCHES "define void @add\\(ptr nocapture nonnull %value, i64 %amount\\)")
    message(FATAL_ERROR "mutable T& parameter is missing nonnull/nocapture attributes")
endif()
